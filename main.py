...
class LocalBlend:
    ...
    def __call__(self, x_t, attention_store):
        ...
        maps = [item.reshape(self.alpha_layers.shape[0], -1, 1, 16,
                             16, MAX_NUM_WORDS) for item in maps]
...
if __name__ == '__main__':
    ...
    for seed in range(25):
        ...
        for i, image in enumerate(images):
            ...
            image_pil.save(f'{out_dir}/seed{seed}-image{i}.png')
            del image, image_pil

        del controller, images, x_t
